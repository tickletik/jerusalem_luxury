...
# this is used as a widget
w_req = forms.TextInput(attrs={'class':'required'})
...
class InfoForm(forms.Form):
    language = forms.ModelChoiceField(queryset=LanguageChoice.objects.filter(is_activated=True))
